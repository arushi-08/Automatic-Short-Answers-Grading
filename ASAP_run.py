...
def loadGloveModel(gloveFile):
    ...
    return model
model = loadGloveModel(r"/home/arushi/Word Embeddings/glove.twitter.27B/glove.twitter.27B.100d.txt")
...
for i in np.unique(data['ID']):
  ...
  #  print (X_train.shape, y_train.shape)
    ...
    model.fit(x=[X_train,X_ref_train],y=y_train, epochs=1,batch_size=1,
